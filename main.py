...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        print("✅ Đã bàn giao lại toàn bộ Camera cho Master thành công!\n")
    except Exception as e:
        print(f"❌ Không thể báo cáo cho Master. Lỗi: {e}")   
...
if __name__ == "__main__":
    ...
    print("\n=======================================================")
    print("🤖 WORKER YOLO AI ĐÃ SẴN SÀNG - ĐANG CHỜ MASTER GIAO VIỆC")
    print("=======================================================\n")
